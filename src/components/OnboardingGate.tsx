            ...
            <div className="space-y-6 text-left bg-white border border-zinc-200/65 rounded-2xl p-8 shadow-md">
              <div className="text-center space-y-2">
                ...
                <p className="text-xs text-zinc-500 leading-relaxed max-w-xs mx-auto">
                  Verify and bind your active profile to start targeting high-converting leads instantly using your real credentials.
                </p>
              </div>

              {/* Secure login form with exactly two fields as requested */}
                ...
                <div className="space-y-1.5">
                  ...
                  <input 
                    ...
                    onChange={e => {
                      ...
                      // Auto-derive a realistic full name from email if name is empty
                      if (ownerName === 'Alex Mercer' || !ownerName) {
                        setOwnerName(extractNameFromEmail(e.target.value));
                      }
                    }}
